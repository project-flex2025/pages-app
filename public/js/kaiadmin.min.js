...
$(document).ready(function () {
  ...
  var toggles = [
    ...
    {
      selector: ".quick-sidebar-toggler",
      className: "quick_sidebar_open",
      state: "m",
    },
    { selector: ".topbar-toggler", className: "topbar_open", state: "v" },
    { selector: ".toggle-sidebar", className: "sidebar_minimize", state: "f" },
    {
      selector: ".page-sidebar-toggler",
      className: "pagesidebar_open",
      state: "b",
    },
  ];
  ...
  toggles.forEach((toggle) => {
    ...
    if (el.length) {
      el.on("click", function () {
        ...
        state
          ? $("html").removeClass(toggle.className)
          : $("html").addClass(toggle.className);
